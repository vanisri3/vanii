...
public class Inventory extends JFrame {
	...
	public Inventory() {
		...
		JLabel fulltotal = new JLabel("");
		fulltotal.setIcon(new ImageIcon("C:\\Users\\Asus\\Pictures\\Picture3.jpg"));
		fulltotal.setBounds(-27, -40, 875, 104);
		panel.add(fulltotal);
		...
		btnNewButton_3.setBounds(390, 405, 89, 28);
