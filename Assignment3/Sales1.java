...
public class Sales extends JFrame {
	...
	public void my_update(String sub  ) { //method my_update to retrieve str
		salesbox.setText(sub);
	  //  textField.setText(tot);
		
	}
	
	public void my_updatee(String  tot ) { //method my_update to retrieve str
		//salesbox.setText(sub);
	    total.setText(tot);
		
	}
	
	public void my_updatee1(String  spend ) { //method my_update to retrieve str
		//salesbox.setText(sub);
	...
	public Sales() {// constructor without argument
		...
		totall.setIcon(new ImageIcon("C:\\Users\\Asus\\Pictures\\Picture10.jpg"));
		totall.setBounds(0, 0, 731, 407);
		panel.add(totall);
